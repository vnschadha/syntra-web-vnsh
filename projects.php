    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7 text-center offset-lg-3 ">
          ...
          <h1 class="upper-heading head-headingtwo section-title heading-color ml-0" data-aos="fade-down" >Our Projects </h1>
         </div>
        </div>
      </div>
        ...
        <div class="image-gallery">
          ...
          <div class="circle-wrapper gallery-items ml-5">
            <div class="circle " data-circle="1" data-aos="flip-left">
              ...
              <div class="text">
                <span style="color: #fff;"> <img class="mb-4 ml-0 image-respon" width="200" src="images/clients-logo/OSIA LOGO-1 (1).png" alt="" srcset="">  </span>
              </div>
              </div>
            </div>
            <div class="circle-wrapper gallery-items ml-5">
              <div class="circle" data-circle="1" data-aos="flip-left">
                ...
                <div class="text ">
                  <span style="color: #fff;"> <img class="mb-4 image-respon" width="230" src="images/clients-logo/TPY FINAL FILE 1.png" alt="" srcset="">  </span>
                </div>
                </div>
              </div>
          </div>
