...
<section id="service">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 text-center offset-lg-3 ">
        <div class="section-heading">
          <h1 class=" head-heading section-title heading-color mt-5 " data-aos="fade-down"> Digital Solutions </h1>
        </div>
      </div>
    </div>
        ...
        <div class="circle-wrapperthree gallery-itemsthree">
          <div class="circle circletwo" data-circle="1" data-aos="flip-left">
            ...
            <div class="videothree">
              <video src="images/syntra-web-video/DIGITAL SOLUTIONS_06.mp4" loop muted>
              </video>
            </div>

            <div class="text">
              <span class="mt-5 span-liners" style=""> See The Magic Digital Solutions </span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-lg-12 mb-100">
      ...
      <p class="" style=" ">At Syntra, we offer a comprehensive suite of <strong>Digital Solutions</strong> tailored to elevate your
      ...
      <p style="">Our approach is collaborative and client-focused. We work closely with you to understand your specific needs and deliver solutions that exceed expectations.</p>
