...
<section id="service"style ="">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 text-center offset-lg-3 ">
        <div class="section-heading">
          <h1 class="head-heading section-title heading-color mt-5 " data-aos="fade-down"> Design Services </h1>
        </div>
      </div>
    </div>
        ...
        <div class="circle-wrapperthree gallery-itemsthree">
          <div class="circle" data-circle="1" data-aos="flip-left">
            ...
            <div class="videothree">
              <video src="images/syntra-web-video/DESIGNS_SMALL (1).mp4" loop muted>
              </video>
            </div>

            <div class="text">
              <span class ="mt-5 span-liners" style=""> See The Magic Of Syntra designs </span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-lg-12 mb-100">
      ...
      <p style= "">Our design services at SYNTRA are dedicated to making your brand visually irresistible. We understand that in
        the world of luxury and high-ticket items, design plays a crucial role in how your brand is perceived. Our
