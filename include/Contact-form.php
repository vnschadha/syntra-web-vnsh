...
<div id="modal-1" class="modal">
  <div class="modal-content">
    ...
    <div class="form-logo">
    <a href="#"><img src="images/Banner/4.jpg" alt="Logo"></a>
</div>
      <div class="container mt-3">
        ...
        <div class="form-container">
          ...
          <h4 class="text-dark sub-headig ml-2" style="font-weight: 600;">We’re excited to work with you! Let us know how
            can we help elevate your
            brand or
            business.
          </h4>
          ...
          <div id="paymentContainer" name="paymentContainer" class="paymentOptions Subbg-color-yelow">
            ...
            <div id="payInvoice" class="sub-headi">
              <label for="paymentInv"> <input id="paymentInv" name="Profiles" type="radio" value="Entrepreneur"
                  required />
                Entrepreneur
              </label>
            </div>
            ...
            <div id="pay3rdParty" class="sub-headi">
              <label for="payment3rd"> <input id="payment3rd" name="Profiles" type="radio" value="Individual"
            ...
            <div class="heading-item">
              ...
              <div class="checkbox-container row">
                <div class="form-check col-6 col-md-4 mb-2 ml-4">
                  <input class="form-check-input" name="BusinessStrategy[]" value="Marketing_Strategy_Development"
                    type="checkbox" id="secondCheck1">
                  <label class="form-check-label" for="secondCheck1"> Marketing Strategy Development</label>
                </div>
                <div class="form-check col-6 col-md-4 mb-2 ml-4">
                  <input class="form-check-input" name="BusinessStrategy[]" value="Positioning_Strategy" type="checkbox"
                    id="secondCheck2">
                  <label class="form-check-label" for="secondCheck2">Positioning Strategy</label>
                </div>
                <div class="form-check col-6 col-md-3 mb-2 ml-4">
                  <input class="form-check-input" name="BusinessStrategy[]" value="Growth_Strategy_Consulting"
                    type="checkbox" id="secondCheck2">
              ...
              <div class="checkbox-container row ">
                ...
                <div class="col-md-4">
                  <div class="form-check mb-2 ml-3">
                    <input class="form-check-input" name="Advertisement[]" value="Television_Commercials"
                      type="checkbox" id="adCheck1">
                    <label class="form-check-label" for="adCheck1">Television Commercials</label>
                  </div>
                  <div class="form-check mb-2 ml-3">
                    <input class="form-check-input" name="Advertisement[]" value="Advertisements_(3D/2D)_Commercials"
                      type="checkbox" id="adCheck2">
                    <label class="form-check-label" for="adCheck2">Advertisements (3D/2D) Commercials</label>
                  </div>
                  <div class="form-check mb-2 ml-3">
                    <input class="form-check-input" name="Advertisement[]" value="Product_Demos_(2D/3D)" type="checkbox"
                      id="adCheck3">
                    <label class="form-check-label" for="adCheck3">Product Demos (2D/3D)</label>
                  </div>
                  <div class="form-check mb-2 ml-3">
                    <input class="form-check-input" name="Advertisement[]" value="Corporate_AV" type="checkbox"
                      id="adCheck4">
                ...
                <div class="col-md-3">
                  <div class="form-check mb-2">
                    <input class="form-check-input" name="Advertisement[]" value="Brand_Films" type="checkbox"
                      id="adCheck5">
                    <label class="form-check-label" for="adCheck5">Brand Films</label>
                  </div>
                  <div class="form-check mb-2">
                    <input class="form-check-input" name="Advertisement[]" type="checkbox" value="Teasers_&_Trailers"
                      id="adCheck6">
                    <label class="form-check-label" for="adCheck6">Teasers & Trailers</label>
                  </div>
                  <div class="form-check mb-2">
                    <input class="form-check-input" name="Advertisement[]" type="checkbox" value="Explainer_Videos"
                      id="adCheck7">
                    <label class="form-check-label" for="adCheck7">Explainer Videos</label>
                  </div>
                  <div class="form-check mb-2">
                    <input class="form-check-input" name="Advertisement[]" type="checkbox" value="Reel_Ads"
                      id="adCheck8">
                    <label class="form-check-label" for="adCheck8">Reel Ads</label>
                  </div>
                  <div class="form-check mb-2">
                    <input class="form-check-input" name="Advertisement[]" type="checkbox" value="Sponsored_Content"
                      id="adCheck13">
                ...
                <div class="col-md-4">
                  <div class="form-check mb-2">
                    <input class="form-check-input" name="Advertisement[]" type="checkbox" value="Product_Showcase_Ads"
                      id="adCheck9">
                    <label class="form-check-label" for="adCheck9">Product Showcase Ads</label>
                  </div>
                  <div class="form-check mb-2">
                    <input class="form-check-input" name="Advertisement[]" type="checkbox" value="Social_Media_Ads"
                      id="adCheck10">
                    <label class="form-check-label" for="adCheck10">Social Media Ads</label>
                  </div>
                  <div class="form-check mb-2">
                    <input class="form-check-input" name="Advertisement[]" type="checkbox" value="Video_Ads"
                      id="adCheck11">
                    <label class="form-check-label" for="adCheck11">Video Ads</label>
                  </div>
                  <div class="form-check mb-2">
                    <input class="form-check-input" name="Advertisement[]" type="checkbox" value="Banner_Ads"
                      id="adCheck12">
                  ...
                  <div class="form-check mb-2">
                    <input class="form-check-input" name="Advertisement[]" type="checkbox" value="Other"
                      id="toggleTextarea">
            ...
            <div class="heading-item">
              ...
              <div class="checkbox-container row" id="section-7">
                ...
                <div class="form-check col-6 col-md-2 mb-2 ml-4">
                  <input class="form-check-input" name="CreativeBrandStrategy[]" type="checkbox" value="Market_Research"
                    id="secondCheck2">
          ...
          <div class=" mt-3">
            <div class="heading-item">
              ...
              <div class="checkbox-container" id="section-2">
                <div class="form-check col-6 col-md-3 mb-2 ml-4">
                  <input class="form-check-input" name="DigitalSolutions[]" type="checkbox" value="Website_Development"
                    id="secondCheck1">
                ...
                <div class="form-check col-6 col-md-3 mb-2 ml-4">
                  <input class="form-check-input" name="DigitalSolutions[]" type="checkbox"
                    value="Website_App_Development" id="secondCheck2">
                  <label class="form-check-label" for="secondCheck2">Website App Development</label>
                </div>
                <div class="form-check col-6 col-md-3 mb-2 ml-4">
                  <input class="form-check-input" name="DigitalSolutions[]" type="checkbox"
                    value="Mobile_App_Development" id="secondCheck2">
                  <label class="form-check-label" for="secondCheck2">Mobile App Development</label>
                </div>
                <div class="form-check col-6 col-md-3 mb-2 ml-4">
                  <input class="form-check-input" name="DigitalSolutions[]" type="checkbox" value="UI/UX_Design"
                    id="secondCheck2">
                  <label class="form-check-label" for="secondCheck2">UI/UX Design</label>
                </div>
                <div class="form-check col-6 col-md-3 mb-2 ml-4">
                  <input class="form-check-input" name="DigitalSolutions[]" type="checkbox"
                    value="Backend_API_Development" id="secondCheck2">
          ...
          <div class=" mt-3">
            <div class="heading-item">
              ...
              <div class="checkbox-container" id="section-8">
                ...
                <div class="form-check col-6 col-md-5 mb-2 ml-4">
                  <input class="form-check-input" name="MarketingAnalytics[]" type="checkbox"
                    value="Customer_Insights_&_Segmentation" id="secondCheck2">
        ...
        <label class="form-check-label" for="secondCheck2"> Illustrations</label>
            ...
            <div class="heading-item">
              ...
              <div class="checkbox-container" id="section-3">
                ...
                <div class="form-check col-6 col-md-2 mb-2">
                  <input class="form-check-input" name="DesignServices[]" type="checkbox" value="Graphic_Design"
                    id="secondCheck2">
                  <label class="form-check-label" for="secondCheck2">Graphic Design</label>

                </div>
                <div class="form-check col-6 col-md-3 mb-2 ml-4">
                  <input class="form-check-input" name="DesignServices[]" type="checkbox" value="Illustrations"
                    id="secondCheck2">
                  <label class="form-check-label" for="secondCheck2"> Illustrations</label>
                </div>
                <div class="form-check col-6 col-md-4 mb-2 ml-4">
                  <input class="form-check-input" name="DesignServices[]" type="checkbox" value="2D Animations"
                    id="secondCheck2">
          ...
          <div class=" mt-3">
            ...
            etc.)" id="secondCheck2">
                ...
                <div class="form-check col-6 col-md-3 mb-2 ml-4">
                  <input class="form-check-input" type="checkbox" name="PackagingandPrinting[]" value="Graphic Design"
                    id="secondCheck2">
                  <label class="form-check-label" for="secondCheck2">Graphic Design</label>
                </div>
                <div class="form-check col-6 col-md-2 mb-2 ml-4">
                  <input class="form-check-input" type="checkbox" name="PackagingandPrinting[]" value="Custom Printing"
                    id="secondCheck2">
          ...
          <div class=" mt-3">
              ...
              <div class="checkbox-container" id="section-6">
                <div class="form-check col-6 col-md-3 mb-2 ml-5">
                  <input class="form-check-input" name="MusicandVideoProduction[]" type="checkbox"
                    value=" Jingles and Brand Anthems" id="  ">
            ...
            Content" id="secondCheck2">
                ...
                <div class="form-check col-6 col-md-3 mb-2  ml-5 ">
                  <input class="form-check-input" name="MusicandVideoProduction[]" type="checkbox" value="Video Editing"
                    id="secondCheck2">
          ...
          <div class=" Subbg-color-yelow">
            ...
            <div class="input__box ">
              ...
              <label class="pere-con">
                <input type="checkbox" name="PhoneNumber" id="phone-checkbox" onclick="toggleInput('phone-input')" />
                Phone Number
              </label>
          ...
          <h4 class="text-dark sub-headig bg-color-yelow" style="font-weight: 600;">4) How Soon Do You Want to Get
            ...
            <div class="form_con ">
              <textarea class="Subbg-color-yelow" name="anything_Else" id="" cols="50" rows="2" placeholder="Optional"
                required></textarea>
            </div>
            <h4 class="text-dark sub-headig bg-color-yelow" style="font-weight: 600;">5) Tell Us About Your Business or
            Project Goals</h4>
          <div class="form_con">
            <textarea class="Subbg-color-yelow" name="tell_Us_About" id="" cols="50" rows="2" placeholder="Optional"
              required></textarea>
