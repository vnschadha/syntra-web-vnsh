...
<div id="videoPlayer" class="video-head responsive-section-phnthree"><!---->
  ...
  <section class="hero-section hero " id="parallax">
    <div class="container">
      <div class="row">
        <div class="col-md-5">
      ...
      <div class="col-md-5">
        <div class="video-wrapper">
          <video autoplay loop muted playsinline>
            <source src="images/syntra-web-video/CUBE GLASS 1-1.mp4" type="video/mp4">
      ...
      <div class="row">
        ...
        <div class="col-md-6 about-head" style="" id="about">
          ...
          <p class="heading-pra pragrp space-pra" data-aos="fade-up" style="font-family:'Nunito', sans-serif;">We are a
            ...
            and cutting-edge digital solutions, we empower B2B and B2C clients to achieve exceptional growth. We know
            how to elevate a brand with our high end professional outputs and have a record of making our clients
            extremely happy.
          </p>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 margin-30px-bottom xs-margin-20px-bottom" data-aos="flip-left">
        <div class="services-block-three">
          <a href="javascript:void(0)">
            ...
            <p class=" xs-line-height-22 " style="font-family:'Nunito', sans-serif">Our purpose is to leverage the power
              of data and creativity to forge meaningful connections between brands and their audiences, enhancing brand
        ...
        <div class="services-block-three">
          <a href="javascript:void(0)">
            ...
            <p class=" xs-line-height-22 " style="font-family:'Nunito', sans-serif">
              ...
              analytics tools to provide insights, enhance campaign performance, and elevate brand presence, ultimately
        ...
        <div class=" services-block-three">
          <a href="javascript:void(0)">
            ...
            <p class=" xs-line-height-22 " style="font-family:'Nunito', sans-serif">Our mission is to deliver unmatched
              ...
              combining creative excellence with advanced analytics, we aim to elevate brand value of 500 businesses and
...
<section id="service">
  <div class="container">
    ...
    <div class="full-gallerytwo">
      <div class="image-gallerytwo">
        ...
        <a href="PACKAGING-PRINTING.php" data-aos="flip-left">
          <div class="gallery-itemstwo">
            <div class="itemtwo">
              <!-- <img src="https://drive.google.com/thumbnail?id=12C1eXDYZzoZxPySLiIvQV5YBkpUzDCbl" /> -->
              <div class="item-titletwo">
                <div class="transparent-backtwo"></div>
        ...
        <a href="MUSIC-&VIDEO-PRODUCTION.php">
          <div class="gallery-itemstwo" data-aos="flip-left">
            <div class="itemtwo">
              <!-- <img src="https://drive.google.com/thumbnail?id=12C1eXDYZzoZxPySLiIvQV5YBkpUzDCbl" /> -->
              <div class="item-titletwo">
...
<div class="video-headtwo responsive-section">
  <video id="videoPlayer" class="headVideotwo" autoplay muted loop playsinline>
    <source src="images/syntra-web-video/Balloons_ALPHA.webm" type="video/webm">

    <source src="images/syntra-web-video/BALLOONS HD.mp4" type="video/mp4">

  </video>

  <section class="hero-sectiontwo hero " id="parallax">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="video-overlay">
            <!-- <video class="background-video" autoplay muted loop>
                <source src="images/syntra-web-video/FINAL-HD-TEST.mp4" type="video/mp4">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 section-kil mb-5">
        ...
        <p class="heading-pra pragrp" data-aos="fade-up" data-aos-delay="100" style=""></p>
        <button id="contact"
          class="btn btn-secondary btn-lg mt-3 mb-5 btnre modal-open responsive-section "
